          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="text-gray-600">Or Ready to Work Online?</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                MyBuddyPH is your go-to outsourcing partner — connecting
                businesses with skilled Filipino professionals.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Whether you're hiring a virtual assistant or you're a skilled
                worker looking for online gigs, we're here to match the right
                talent with the right need.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="space-y-4">
              ...
              <p>Connectivity, Made Easy</p>
            </div>
            <div className="space-y-6">
              <p className="text-lg lg:text-xl text-gray-600 leading-relaxed">
                We're launching a dedicated outsourcing platform that bridges
                global clients with skilled Filipino professionals. From virtual
                assistants to specialized talent — seamless hiring starts here.
                Let's make a place where Filipinos reign! Stay tuned!
              </p>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-lg">
                    Get screened and added to our VA pool
                  </p>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="text-lg">
                    Start working when matched to a client
                  </p>
                </div>
              </CardContent>
            </Card>
